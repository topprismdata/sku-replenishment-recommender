"""
AG v23 — Optuna 自动调优 N
===========================
思路: 用 Optuna 找最优的 N 公式参数
- 每渠道的 N 公式: N = base + mult * typical_n
...
def main():
    ...
    for ch in ['channel_a']:
        ...
        model = TabularPredictor(
            ...
            path=f'ag_v23_{ch}_w{tw}', verbosity=0,
        ).fit(
            train_data=train_df,
        ...
        print(f"    对比固定N=25: F1={100*f1_fixed:.0f}%")
